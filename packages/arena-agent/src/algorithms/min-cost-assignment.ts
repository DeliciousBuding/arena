 ...
 *
 * Returns one selected column per row, minimizing total finite cost. The implementation
 * uses the classic O(rows^2 * columns) potential/slack formulation and resolves equal
 * slack by lower column index, making output stable across runs.
 */
