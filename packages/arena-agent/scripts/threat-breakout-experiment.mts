/**
 * threatBreakout A/B 实验（2026-08-06，第三十五轮）：
 * 场景 = 四向包围（p2 4 Vanguard 围 p1 Core [0,0]，12 格内四轴无逃逸 → BREAKOUT）
...
const RESULT_FILE = "threat-breakout-result.txt";
  ...
  return {
    ...
    players: [
      ...
      },
      {
        ...
        units: [
          // 四向包围 p1 Core（4 格四轴——p1 Core 视野 5 内可见全部 → BREAKOUT 触发）
          { id: "55555555-5555-5555-5555-555555555501", owner: "p2", position: [4, 0], hp: 4, unitType: "VANGUARD", cargo: 0 },
          { id: "55555555-5555-5555-5555-555555555502", owner: "p2", position: [-4, 0], hp: 4, unitType: "VANGUARD", cargo: 0 },
          { id: "55555555-5555-5555-5555-555555555503", owner: "p2", position: [0, 4], hp: 4, unitType: "VANGUARD", cargo: 0 },
          { id: "55555555-5555-5555-5555-555555555504", owner: "p2", position: [0, -4], hp: 4, unitType: "VANGUARD", cargo: 0 },
        ],
      },
    ],
...
const rows: string[] = [];
rows.push(`threatBreakout A/B（${TICKS} ticks × ${SEEDS.length} seeds，四向包围 p1 3 worker，refill 65）`);
rows.push("=".repeat(88));
