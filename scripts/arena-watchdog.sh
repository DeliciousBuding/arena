...
# Scheduled Task 从协调仓脚本进入，但生产代码固定绑定经过晋级的 v3 worktree；
# main/临时开发 worktree 的脏 WIP 永远不能被 watchdog 拉进 live supervisor。
REPO="/d/Code/Projects/arena/arena-ts/.worktrees/production-runtime-v3"
...
echo "$(now) supervisor restarted (pid $!, release=production-runtime-v3 alliance-shadow=3 director=ASSIST_ONLY/period4/skew2)" >> "$LOG"
